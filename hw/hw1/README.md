...
**Для дотримання принципу єдиної відповідальності необхідно розділити логіку класу на кілька окремих класів, кожен з яких матиме лише одну відповідальність**.
